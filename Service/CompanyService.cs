...
namespace Service
{
    internal sealed class CompanyService : ICompanyService
    {
        ...
        {
            var company = await GetCompanyIfExist(companyId, trackChanges);
        ...
        private async Task<Company> GetCompanyIfExist(Guid companyId, bool trackChanegs)
        {
            var company = await repository.Company.GetCompanyAsync(companyId, trackChanegs);
            if(company is null)
